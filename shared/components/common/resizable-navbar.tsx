...
import { X, MenuIcon, Truck } from "lucide-react";
      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-light-500 dark:bg-emerald-300/30"
            />
          )}
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <span className="font-medium text-black dark:text-white font-bold">
        Ingress
      </span>
    </a>
  );
